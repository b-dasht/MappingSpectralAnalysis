...
def normalise_data(normalising_data, max_val=100, y_col=0, x_col=3, each_spectra=False, normal_fig=False):
    """
    ...
    max_val : int
        The new maximum limit for the normalised data (e.g., 100 or 1). Default is set to 100.
    y_col : int, optional
    ...
    each_spectra : bool, optional
        ...
        y-axis data as a group. Default is False.
    x_col : int, optional
