...
# Example usage with individual normalisation and group normalisation
...
# from MapSpecSis_Baseline import baseline_correction
# from MapSpecSis_Crop import crop_data
